...
//  ImGuiPlatformIO interface. 2022-02-07: Added
//  ImGui_ImplGlfw_InstallCallbacks()/ImGui_ImplGlfw_RestoreCallbacks() helpers
//  to facilitate user installing callbacks after iniitializing backend.
...
static void ImGui_ImplGlfw_UpdateMouseData()
{
    ...
    for (int n = 0; n < platform_io.Viewports.Size; n++)
    {
        ...
        if (is_window_focused)
        {
            ...
            // enabled by user) When multi-viewports are enabled, all Dear ImGui
        ...
        // viewports with the _NoInputs flag.
...
static void ImGui_ImplGlfw_UpdateMonitors()
{
    ...
    for (int n = 0; n < monitors_count; n++)
    {
        ...
        if (w > 0 && h > 0) // Workaround a small GLFW issue reporting zero on monitor
...
static LRESULT CALLBACK WndProcNoInputs(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    if (msg == WM_NCHITTEST)
    {
        ...
        // want to detect the window behind the one we are dragging. If you
        // cannot easily access those viewport flags from your windowing/event
        // code: you may manually synchronize its state e.g. in your main loop
        // after calling UpdatePlatformWindows(). Iterate all viewports/platform
        // windows and pass the flag to your windowing system.

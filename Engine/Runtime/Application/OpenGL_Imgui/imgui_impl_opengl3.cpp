...
//  ImGuiPlatformIO interface. 2021-12-15: OpenGL: Using buffer orphaning +
//  glBufferSubData(), seems to fix leaks with multi-viewports with some Intel
//  HD drivers. 2021-08-23: OpenGL: Fixed ES 3.0 shader ("#version 300 es") use
//  normal precision floats to avoid wobbly rendering at HD resolutions.
//  2021-08-19: OpenGL: Embed and use our own minimal GL loader
...
bool ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    if (bd->GlVersion >= 320)
        io.BackendFlags |= ImGuiBackendFlags_RendererHasVtxOffset; // We can honor the
                                                                   ...
                                                                   // large meshes.
#endif
    io.BackendFlags |= ImGuiBackendFlags_RendererHasViewports; // We can create

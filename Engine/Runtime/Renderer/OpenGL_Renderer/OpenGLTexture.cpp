...
namespace Engine
{
    OpenGLTexture2D::OpenGLTexture2D() { glCreateTextures(GL_TEXTURE_2D, 1, &m_RendererID); }
    ...
    void OpenGLTexture2D::Bind(const uint32_t& slot) const { glBindTextureUnit(slot, m_RendererID); }
    ...
    void* OpenGLTexture2D::GetTextureID() const { return (void*)(uint64_t)m_RendererID; }
} // namespace Engine